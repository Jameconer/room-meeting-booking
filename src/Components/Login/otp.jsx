            ...
            Swal.fire({
                html: `
                        <div class="relative flex flex-col items-center justify-center min-h-[200px] bg-white overflow-hidden rounded-xl">
                          <!-- Wave Background -->
                          <svg class="absolute top-0 left-0 w-full h-full opacity-20"
                          ...
                          <div class="relative flex flex-col items-center justify-center">
                            ...
                            <span class="mt-4 text-lg text-gray-700 font-medium">กำลังตรวจสอบ...</span>
                          </div>
                        </div>
                      `,
        ...
        <div className="relative flex items-center justify-center min-h-screen bg-gray-50 overflow-hidden">
            ...
            <div className="relative sm:bg-white p-8 rounded-xl sm:shadow-lg w-full max-w-md z-10">
                ...
                <div className="mb-6 relative">
                    ...
                    />
                    <label className="absolute left-3 text-gray-600 transition-all 
                ...
                <button
                    ...
                    className="w-full py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition mb-3"
                >
                    ยืนยัน
                </button>
                <button
